...
public abstract class AbstractRegion implements IProtectedRegion {
    ...
    public CompoundTag serializeNBT() {
        ...
        //-------------------------------------------------------------------
        if (requiredTag != null) {
            nbt.putString(RegionNbtKeys.REQUIRED_TAG, requiredTag);
        }
    ...
    public void deserializeNBT(CompoundTag nbt) {
        ...
        //-------------------------------------------------------------------
        //new
        if (nbt.contains(RegionNbtKeys.REQUIRED_TAG)) {
            String tag = nbt.getString(RegionNbtKeys.REQUIRED_TAG);
            this.requiredTag = tag.isEmpty() ? null : tag;
        }
        //-------------------------------------------------------------------
